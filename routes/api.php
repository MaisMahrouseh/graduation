...
//Route::middleware(['auth:api' , 'cors'])->group(function () {
    ...
    Route::post('editunite', [UniteController::class, 'editUnite']);
    ...
    Route::get('getadminproduct', [ProductController::class,'getAdminProducts']);
...
Route::middleware(['auth:api' , 'isUser'])->group(function () {
    ...
    Route::post('detailsResultCart', [CartController::class, 'detailsResultCart']);
    Route::post('nearestCart', [CartController::class, 'nearestCart']);
